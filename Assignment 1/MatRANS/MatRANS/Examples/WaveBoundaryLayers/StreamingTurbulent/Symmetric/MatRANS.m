...
% Wave input 
T = 6; % Wave period (s)
c = 7.5; % Celerity (if streaming=1, used to calculate d/dx = -1/c*d/dt) (m/s)
...
if iwave == 1 % Input for second-order Stokes signal, with free stream velocity: U_1m*sin(omega*t) - U_2m*cos(2*omega*t)
  U_1m = 0.94341; % Primary amplitude of free stream velocity (m/s)
  U_2m = 0; 0.047123; % Amplitude of second harmonic free stream velocity (m/s)
...
iextrap = 1; % Use extrapolation to avoid overrloading: 0: Off, 1: On
