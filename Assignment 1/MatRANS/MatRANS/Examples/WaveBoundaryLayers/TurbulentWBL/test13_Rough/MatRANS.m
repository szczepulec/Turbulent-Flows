...
y = h_m.*logspace(-2.8,0,ny-1); y = y - y(1); y = [y h_m]; % Define grid, logarithmic stretching
...
% Sediment input
d = 0.35/1000; % Grain size (m)
k_N = 0.84/1000; % Nikuradse's equivalent sand grain roughness (m)
