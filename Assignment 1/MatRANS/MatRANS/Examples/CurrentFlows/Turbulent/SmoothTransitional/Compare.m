...
% Compares both transitional (turb=2) and standard (turb=1) 
% k-omega model results
clear all; close all;
...
% Legend
hl = legend('Computed (trans.)','Fuhrman et al. (2010)','Logarithmic');
