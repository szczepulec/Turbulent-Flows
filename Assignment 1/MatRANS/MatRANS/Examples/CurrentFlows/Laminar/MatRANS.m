...
% Grid input
h_m = 1.0; % Height of model depth (m)
ny = 100; % Numbers of grid points in the vertical direction
y = linspace(0,h_m,ny); % Define grid, linear spacing
%y = h_m.*logspace(-4,0,ny-1); y = y - y(1); y = [y h_m]; % Define grid, logarithmic stretching
...
% Current input
Px = -0.001; % Constant added to 1/rho*dpdx (for no current, just set to zero) (m/s^2)
