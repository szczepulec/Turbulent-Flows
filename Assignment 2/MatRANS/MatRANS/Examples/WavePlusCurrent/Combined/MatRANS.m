...
if iwave == 1 % Input for second-order Stokes signal, with free stream velocity: U_1m*sin(omega*t) - U_2m*cos(2*omega*t)
  U_1m = 1.17; % Primary amplitude of free stream velocity (m/s)
...
% Initial conditions
load('../CurrentOnly/out_MatRANS.mat','U','K','W','C');
U = U(end,:)'; K = K(end,:)'; W = W(end,:)'; C = C(end,:)'; % Use end of pure current simulation
