...
streaming = 1; % 0: Leading-order terms only i.e. d/dx=0, 1: second order (streaming) terms added
...
c = 20; % Celerity (if streaming=1, used to calculate d/dx = -1/c*d/dt) (m/s)
...
w_s = 0.01; % Fall velocity (if 0, then calculated empirically) (m/s)
...
K(1:ny,1) = 0.0.*1e4.*W.*nu; % Turbulent kinetic energy density (m^2/s^2)
