...
for i = nT+1:10*nT:length(t) % Does so every 10th period
  ...
  % Plot computed streaming velocity profile
...
% Add streaming velocity from Holmedal & Myrhaug
UsHM = 0.46.*3/4 % Holmedal & Myrhaug (2009)
hold on; plot(UsHM,y(end-9:end)/a,'ro'); hold off;
