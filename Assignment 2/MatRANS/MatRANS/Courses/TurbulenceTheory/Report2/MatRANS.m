...
% Current input
% Px = -0.0026039; % Constant added to 1/rho*dpdx (for no current, just set to zero) (m/s^2)
Px = -0.0025160; % Constant added to 1/rho*dpdx (for no current, just set to zero) (m/s^2)
...
k_N = 7.5352e-06; % Nikuradse's equivalent sand grain roughness (m)
